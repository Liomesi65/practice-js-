...
const lio = {
  name: 'momaher',
  possition: 'team leder',
  phonNumber: 112233848,
};
const check = function (flightNum, passenger) {
  flightNum = 'LHWE2';
  passenger.name = 'Mr.' + passenger.name;
  if (passenger.passport === 112233848) {
    alert('check in ');
  } else {
    alert('worong passport');
  }
};
// check(flight, lio);
// console.log(flight);
...
//   return [frist.toLowerCase(), ...others].join('');
// };
...
//   console.log('lio');
// };
// document.body.addEventListener('click', high5)2
/*
///////////////////////////////////////
